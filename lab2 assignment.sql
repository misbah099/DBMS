...
INSERT INTO EMP_trainee (Emp_id,Name,Basic,Designation,Age) select ID,Name,Basic,Designation,Age 
...
#EMP1 table and add data for the Skills and DOJ columns according to your own wis
